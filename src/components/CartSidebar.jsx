            ...
            <div className={`fixed top-0 right-0 h-full w-full sm:w-96 bg-white shadow-2xl z-50 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="flex flex-col h-full">
                    <div className="bg-purple-600 text-white p-6 flex items-center justify-between">
                        ...
                        <button
                            onClick={onClose}
                            className="hover:bg-purple-700 rounded-full p-2 transition-colors"
                        >
                            <X className="w-6 h-6" />
                        </button>
                    </div>
                    ...
                    {cartItems.length > 0 && (
                        <div className="border-t border-gray-200 p-6 bg-gray-50">
                            ...
                            <button
                                onClick={onClose}
                                className="w-full mt-2 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-3 rounded-lg transition-colors"
                            >
                                Continue Shopping
                            </button>
                        </div>
